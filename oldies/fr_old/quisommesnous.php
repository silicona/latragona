...
<html lang="fr">
<head>
	<title>Qui est La Tragona</title>
...
<body>
	...
	<section id="menuidiomas" class="movil">
		<ul>
			...
			<li><a href="#" alt="français" title="Web français"><img src="../media/banderas/francia.png" alt="Francia" title="Francia"><span>Français</span></a></li>
	...
	<div id="contenedor">
		...
		<h1>Qui est La Tragona</h1>
			<section>
				...
				<p>
					La Tragona est une oasis à Madrid avec une atmosphère agréable, grâce au traitement personnel que nous mettons au service de notre <a href="avaler.php" alt="Pour avaler" title="Tapas and portions">portions</a>, toasts et <a href="pousser.php" alt="Pour pousser" title="Les boissons">vins</a>:
				</p>

				<ul id="descripcion">
					<li><img src="../imag_ejemplos/moneda2.jpg" alt="Pilar" title="Pilar" class="retrato"><p>Pilar - Ce que Pilar aime le plus, c'est que les plats reviennent à vide et qu'il y a un sourire sur le visage du restaurant. C'est pourquoi profitez de La Tragona pour un traitement amical et proche de tous ceux qui veulent s'arrêter ici.</p></li>
					<li><img src="../imag_ejemplos/moneda1.jpg" alt="Luis" title="Luis" class="retrato"><p>Luis - Un acteur qui, à un moment de chômage dans son métier, a commencé à étudier la cuisine. Maintenant, il a découvert les émotions que peut provoquer une nourriture avec des produits du marché.</p></li>
				</ul>

				<p>
					Nous travaillons avec des produits frais et écologiques, pour offrir une alimentation saine et saine. Pour cette raison, nous nous fournissons sur les marchés voisins qui nous entourent, tels que Antón Martín, La Latina ou San Fernando.
				</p>
			</section>

			<section id="redes">
				<h2>La Tragona en internet</h2>
				<div id="tw" class="red">
